...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#faf7f2] text-[#1a1614]">
      {/* NAVIGATION */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#faf7f2]/80 backdrop-blur-xl border-b border-[#c9a84c]/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2.5 group">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#c9a84c] to-[#e8c97a] flex items-center justify-center shadow-lg shadow-[#c9a84c]/20 group-hover:shadow-[#c9a84c]/30 transition-all">
          ...
          {navOpen && (
            <div className="md:hidden pb-4 border-t border-[#c9a84c]/10 pt-4 flex flex-col gap-3">
      ...
      <section className="min-h-screen flex items-center justify-center pt-16 pb-12 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#c9a84c]/20 bg-[#c9a84c]/5 text-xs text-[#c9a84c] mb-8">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05] text-[#1a1614]">
            Your content.<br />
            <span className="bg-gradient-to-r from-[#c9a84c] to-[#e8c97a] bg-clip-text text-transparent">Handled.</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link href="/support">
              <button className="px-8 py-3.5 rounded-xl text-sm font-medium text-[#6b5a5e] border border-gray-200 hover:border-[#c9a84c] hover:text-[#1a1614] transition-all inline-flex items-center gap-2">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-4xl font-bold tracking-tight text-[#1a1614]">
              ...
              <span className="bg-gradient-to-r from-[#c9a84c] to-[#e8c97a] bg-clip-text text-transparent">I'll schedule it all.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.step} className="bg-white/80 backdrop-blur-md border border-[#c9a84c]/10 rounded-2xl p-6 text-center hover:shadow-lg hover:shadow-[#c9a84c]/5 transition-all duration-300">
                <div className="w-10 h-10 rounded-full bg-[#c9a84c]/10 border border-[#c9a84c]/20 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-4xl font-bold tracking-tight text-[#1a1614]">
              ...
              <span className="bg-gradient-to-r from-[#c9a84c] to-[#e8c97a] bg-clip-text text-transparent">Nothing you don't.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f) => (
              <div key={f.title} className="bg-white/80 backdrop-blur-md border border-[#c9a84c]/10 rounded-2xl p-5 hover:shadow-lg hover:shadow-[#c9a84c]/5 transition-all duration-300 hover:border-[#c9a84c]/30">
                <div className="w-9 h-9 rounded-lg bg-[#c9a84c]/10 border border-[#c9a84c]/15 flex items-center justify-center mb-3">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-[#faf7f2] to-[#f5f0ea]/50">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#f5f0ea]/60 backdrop-blur-md border border-[#c9a84c]/10 rounded-2xl p-8 sm:p-10 text-center shadow-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#c9a84c]/10 text-[#c9a84c] text-xs mb-6">
              <Wand2 className="w-3 h-3" />
              Mission Control
            </div>
            <div className="bg-[#1a1614]/90 rounded-2xl p-4 sm:p-6 text-left shadow-2xl border border-[#c9a84c]/10">
              ...
              <p className="text-sm text-[#faf7f2]/80 font-mono mb-3">
                <span className="text-[#c9a84c]">$</span> Create 15-sec viral video for Maverick mop soap, post every 2 days to TikTok & IG Reels
              </p>
              <div className="space-y-2 text-xs font-mono">
                <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#c9a84c] animate-pulse" /><span className="text-[#faf7f2]/60">Generating viral script with trending hook...</span></div>
                <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#c9a84c] animate-pulse" /><span className="text-[#faf7f2]/60">Creating video with text overlays & music...</span></div>
                ...
                <div className="pt-2 border-t border-[#faf7f2]/10"><span className="text-[#c9a84c]">✅ Campaign created & published to 7 platforms. Next post: today 7:30pm EST (TikTok peak time)</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold tracking-tight text-[#1a1614] mb-4">
            Built for the creator<br />who's <span className="bg-gradient-to-r from-[#c9a84c] to-[#e8c97a] bg-clip-text text-transparent">ready to scale.</span>
          </h2>
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
            {[
              ...
              <div key={s.label} className="bg-white/80 backdrop-blur-md border border-[#c9a84c]/10 rounded-2xl p-4">
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white/80 backdrop-blur-md border border-[#c9a84c]/10 rounded-2xl p-8 text-center border-[#d4a0a0]/20">
