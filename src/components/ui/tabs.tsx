...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-lg bg-zinc-900/80 p-1 text-zinc-400 border border-white/5",
      className
    )}
    {...props}
  />
